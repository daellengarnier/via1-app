...
const placeTitles = new Set(["Parking", "Zufahrt & Vorplatz", "Eingang / Treppenhaus", "Wohnungen", "Saal / Spinnerei", "Pyramide", "Dach / Terrasse", "Waschküche", "Garten", "Sauna"]);
const technicalTitles = new Set(["Brandschutz", "Elektroinstallation", "Sanitäre Installation", "Heizung"]);
...
async function main() {
  ...
  const pairs = [["Waschküche", "Entsorgung & Recycling"], ["Saal / Spinnerei", "Brandschutz"], ["Pyramide", "Brandschutz"], ["Sauna", "Brandschutz"], ["Garten", "Entsorgung & Recycling"], ["Wohnungen", "Mietwesen"]];
